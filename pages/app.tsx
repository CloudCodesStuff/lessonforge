            ...
            <div className="flex h-screen font-plus">
                ...
                <div className="w-full md:w-1/2 ">
                    <div className=' p-5'>
                        ...
                        <h2 className='text-4xl md:text-5xl my-3 font-bold pb-2'>Let's get Started!✌️</h2>

                            {/* Error message */}
                            {error && (
                                <p className='text-xs relative  py-4 text-red-500'>Woah! That's a lot of text. Maybe cut it down a bit?</p>
                            )}
                            {defaultErr && (
                                <p className='text-xs relative py-4 text-blue-500'>Please fill out all sections!</p>
                            )}

                            <div className='mb-4'>
                                <label htmlFor='topic' className='block text-sm font-normal text-gray-700'>
                                    Topic
                                </label>
                                <textarea
                                    name='topic'
                            ...
                            <div >
                                <div className='mb-4'>
                                <label htmlFor='level' className=' block text-sm font-normal text-gray-700'>
                                    Grade level
                                </label>
                                <select
                                    name='level'
                                ...
                                <div className='mb-4'>
                                    <label htmlFor='length' className='block text-sm font-normal text-gray-700'>
                                        Length (in minutes)
                                    </label>
                                    <input
                                        type='number'
                                        ...
                                        onChange={(e) => setLessonPlan({ ...lessonPlan, length: parseInt(e.target.value) })}
                                        className='mt-1 p-2 rounded-md border-indigo-500 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block w-full sm:text-sm border-2'
                                ...
                                {suggestion && (
                                    <div className='mt-4'>
                                        <h3 className='text-xl font-bold'>Suggested lesson plan:</h3>
                                        <div className='mt-2'>
                                            <pre className='font-plus whitespace-pre-wrap'>{suggestion}</pre>
                                        </div>
                                    </div>
                                )}
                            </div>
                ...
                <div className="hidden md:block md:w-1/2 p-10  bg-indigo-500">
                    <div className='flex'>
                        <div className='justify-center'>g</div>
                    </div>
                </div>
            </div>
